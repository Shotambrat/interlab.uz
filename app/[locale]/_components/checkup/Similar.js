        ...
        {similarCheckup?.slice(0, 3).map((item, index) => {
          ...
          return (
            <a
              ...
              className={`relative rounded-3xl p-8 text-black overflow-hidden flex items-center slg:min-h-[320px] ${
                index === 0
                  ? 'col-span-1 slg:col-span-7'
                  : index === 1
                    ? 'col-span-1 slg:col-span-5'
                    : 'col-span-1 slg:col-span-5'
              }`}
            >
