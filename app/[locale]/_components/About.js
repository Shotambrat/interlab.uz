      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col gap-8">
        <div className="flex gap-4 justify-between max-mdx:flex-col w-full">
          ...
          <div className="flex-1">
            ...
            Клиника Intermed – это современный медицинский комплекс, предлагающий широкий спектр услуг для диагностики, лечения и профилактики заболеваний. Мы гарантируем высокое качество обслуживания, внимательность и заботу о наших пациентах.
            </p>
          </div>
        </div>
