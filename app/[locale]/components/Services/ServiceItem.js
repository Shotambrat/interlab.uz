  ...
  return (
    <div  className="w-full h-[200px] cursor-pointer slg:h-[200px] rounded-3xl pl-6 py-6 bg-slate-100">
      <div className="flex flex-col h-full justify-between items-start">
        ...
        {/* PEREYTI */}
        {application && (
          <div className='w-full flex flex-col  mdl:flex-row gap-[10px]'>
          <Link href={`tel:+998977578822`} className='bg-[#FB6A68] py-[12px] px-[16px] text-white rounded-full mdl:py-[13px] mdl:px-[25px] font-bold'>
              {locale === 'ru' ? 'Позвонить' : 'Telefon qilish'}
          </Link>
          <button onClick={handleOpen} className=' text-[#FB6A68] rounded-full py-[12px] px-[16px] border border-[#FB6A68] mdl:py-[13px] mdl:px-[25px] font-bold'>
